...
<head>
    ...
    <title>Alfasalam Admin Page @yield('title-page')</title>
...
<body>
    ...
    <!--
        ...
        -->
    <div id="page-container" class=" enable-page-overlay  side-scroll page-header-fixed page-header-dark">
        <!-- Sidebar -->
        <!--
                    ...
                    <div class="dropdown d-inline-block ml-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="page-header-user-dropdown">
                            ...
                            <div class="p-2">
                                ...
                                <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{route('adm1n.logout')}}">
                                    <span>Log Out</span>
